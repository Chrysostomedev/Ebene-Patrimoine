...
export const useSites = () => {
  ...
  const [sitesSelect, setSitesSelect] = useState<Site[]>([]);
  ...
  // ─────────────────────────────────────────────
  // FETCH SIMPLE — pour les selects (Liste complète)
  // ─────────────────────────────────────────────
  const fetchSitesAll = async () => {
    try {
      const items = await getSelectSites();
      setSitesSelect(items);
    } catch {
      setSitesSelect([]);
    }
  };
