    ...
    <div className="rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="bg-white px-8 py-10">
        ...
        >
          ...
          {/* Erreur */}
          {error && (
            <div className="flex items-start gap-3 bg-theme-primary border border-red-200 text-red-700 px-4 py-3 rounded-xl text-sm">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 text-center text-xs text-gray-400">
          © {new Date().getFullYear()} La poste • Accès réservé aux utilisateurs autorisés
        </div>
      </div>
    </div>
  </div>
